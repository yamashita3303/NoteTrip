...
urlpatterns = [
    ...
    path('my_spots/', views.my_spots, name='my_spots'),
    path('spot/<int:spot_id>/', views.spot_detail, name='spot_detail'),
    path('remove_spot/<int:spot_id>/', views.remove_spot, name='remove_spot'),
    path('edit_spot/<int:spot_id>/', views.edit_spot, name='edit_spot'),
    ...
    path('schedule/<int:plan_id>/<int:schedule_id>/confirmation/', views.schedule_kakunin, name='schedule_kakunin'),
